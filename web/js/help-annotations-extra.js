...
'remapper': [
  { page: { en: 'Tab Summary', ko: '탭 요약' }, items: [
    { sel: '#page-title', text: { en: 'Class Remapper Tab\nChange, merge, or delete class IDs\nin YOLO labels.\nAuto-reindexing keeps IDs contiguous.', ko: '클래스 재매핑 탭\nYOLO 라벨의 클래스 ID를 변경, 병합,\n삭제하는 탭입니다.\n자동 재인덱싱으로 연속 ID를 유지합니다.' } },
  ]},
  { page: { en: 'Remapping Settings', ko: '재매핑 설정' }, items: [
...
'quality': [
  { page: { en: 'Tab Summary', ko: '탭 요약' }, items: [
    { sel: '#page-title', text: { en: 'Image Quality Checker Tab\nAutomatically measure image quality metrics\nsuch as blur, brightness, entropy, and aspect ratio\nto filter out problematic images.', ko: '이미지 품질 검사 탭\n흐림, 밝기, 엔트로피, 종횡비 등\n이미지 품질 지표를 자동 측정하여\n문제 이미지를 필터링하는 탭입니다.' } },
  ]},
  { page: { en: 'Input & Results', ko: '입력 & 결과' }, items: [

...
var _ANNOTATIONS_MAIN = {
  ...
  settings: [
    ...
    {
      page: { en: 'Per-Class Settings', ko: '클래스별 설정' },
      items: [
  ...
  splitter: [
    ...
    {
      page: { en: 'Split Settings', ko: '분할 설정' },
      items: [
